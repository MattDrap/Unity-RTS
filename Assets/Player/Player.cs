...
public class Player : MonoBehaviour {
	public int startGold, startPower, startPowerLimit;
	...
	void Awake() {
		...
		resourceLimits = InitResourceLimitsList();
	}
	...
	private Dictionary< ResourceType, int > InitResourceLimitsList() {
		Dictionary< ResourceType, int > list = new Dictionary< ResourceType, int >();
		list.Add(ResourceType.Power, 0);
		return list;
	}
	...
	public void CreateBuilding(string buildingName, Vector3 buildPoint, Unit creator, PlayingArea playingArea) {
	...
	public void StartConstruction() {
		if (resources [ResourceType.Gold] - tempBuilding.cost >= 0) {
			...
			RemoveResource (ResourceType.Gold, tempBuilding.cost);
		}
	}
