...
public class HUD : MonoBehaviour {
	...
	private void DrawResourcesBar() {
		...
		int topPos = 4, iconLeft = 4, textLeft = 60;
		DrawResourceIcon(ResourceType.Gold, iconLeft, textLeft, topPos);
		iconLeft += TEXT_WIDTH;
		textLeft += TEXT_WIDTH;
		DrawResourceIconPower(ResourceType.Power, iconLeft, textLeft, topPos);
	...
	private void DrawResourceIconPower(ResourceType type, int iconLeft, int textLeft, int topPos) {
