...
namespace RTS{
	public static class WorkManager{
		public static Rect CalculateSelectionBox(Bounds selectionBounds, PlayingArea playingArea) {
			...
			float selectBoxTop = playingArea.area.height + playingArea.not_playable_bottom.height - (screenBounds.center.y + screenBounds.extents.y);
		...
		public static ResourceType GetResourceType(string type) {
			switch(type) {
			case "Money": return ResourceType.Gold;
